...
function show_modal_help(item) {
  switch (item) {
    ...
    case 'envelope':
      ...
      "<p>Примечание: при синтезе звука автоматически добавляется снижение амплитуды до 0 между последней заданной точкой и окончанием звучания.</p>" +
      "</div>";
      break;
    case 'sounddevice':
      title = "Звуковое устройство";
      html = "<div style='text-align: left;'>" +
      "<p>Звуковое устройство -- элемент, представляющий звуковое устройство компьютера. На схеме обязательно должно присутствовать одно звуковое устройство." +
      "</div>";
      break;
    case 'mixer':
      title = "Микшер";
      html = "<div style='text-align: left;'>" +
      "<p>Микшер -- элемент, суммирующий все поступающие на его вход сигналы.</p>" +
      "</div>";
      break;
    default:
      title = "Справка";
